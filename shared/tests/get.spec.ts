...
describe('get properties test', () => {
  const simpleObject = { simple: { a: 2 } };
  const complexObject = { complex: [{ a1: null }, { a1: { b1: { c1: { d1: 'complex[1].a1.b1.c1.d1', d2: 'complex[1].a1.b1.c1.d2', d3: 'complex[1].a1.b1.c1.d3' }, c2: { d1: { e1: 'complex[1].a1.b1.c2.d1.e1' } } } } }] };
  const falsyObject = { falsy: { null: null, undefined: undefined, 0: 0 } };
